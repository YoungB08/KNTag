    ...
    <div class="kn-nav-wrap">
      <nav class="kn-nav">
        ...
        <div class="kn-nav-center">
          <button class="kn-nav-btn active"><i class="fa-solid fa-gauge-high"></i> Dashboard</button>
          <button class="kn-nav-btn" data-go="/bio/layout"><i class="fa-solid fa-user"></i> Bio layout</button>
          <button class="kn-nav-btn" data-go="/nfc"><i class="fa-solid fa-id-card-clip"></i> Thẻ NFC</button>
          <button class="kn-nav-btn" data-go="/history"><i class="fa-regular fa-clock"></i> Lịch sử</button>
        </div>
        ...
        <div class="kn-nav-right">
          ...
          <div class="kn-avatar-wrap" id="nav-avatar-wrap">
            <div class="kn-avatar" id="nav-avatar"><?= htmlspecialchars($avatarLetter) ?></div>
            <div class="kn-dropdown" id="nav-dropdown">
              ...
              <?php else: ?>
                <div class="kn-dropdown-header">Đang đăng nhập: <?= htmlspecialchars($nickname ?: 'User') ?></div>
